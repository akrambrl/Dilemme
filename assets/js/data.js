...
const OPTION_GROUPS = {
  ...
  parfumTiramisu: {
    ...
    required: true,
    choices: [
      { id: 'pistache-framboise', label: 'Pistache framboise', price: 0 },
      { id: 'daim-caramel', label: 'Daim caramel', price: 0 },
      { id: 'nutella-speculoos', label: 'Nutella spéculoos', price: 0 },
      { id: 'mangue-passion', label: 'Mangue passion', price: 0 },
    ],
  },
  sansIngredient: {
    id: 'sansIngredient',
...
const PRODUCTS = [
  ...
  /* ------------------------------------------------------------ Desserts */
  {
    ...
    imageFit: 'contain',
    tags: [],
    description: 'Quatre parfums au choix, préparé en pot individuel.',
    options: ['parfumTiramisu'],
  },
  {
    id: 'flankie',
    name: 'Flankie',
  ...
  {
    id: 'polara-limone-zenzero',
    name: 'Polara Limone Zenzero',
    category: 'boissons',
    price: 2.8,
    emoji: '🫚',
    image: 'polara-limone-zenzero',
    imageExt: 'webp',
    imageFit: 'contain',
    tags: ['sicilien'],
    description: 'Citron de Sicile et gingembre, la version qui réveille.',
    options: [],
  },
  {
    id: 'canette',
  ...
  {
    id: 'cristaline-aromatisee',
    name: 'Cristaline aromatisée',
    category: 'boissons',
    price: 1.9,
    emoji: '🍓',
    tags: [],
